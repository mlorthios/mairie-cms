...
<html>
	<head>
        ...
        <meta name="keywords" content="<?= strtolower($data['title']) ?>">
            ...
            <div class="col-md-8">
                <div class="panel panel-primary">
                    <div class="panel-heading">
                        <i class="fa fa-newspaper"></i> <?= $data['title']; ?>
                    </div>
                    ...
                    <div class="panel-body">
                        <form id="__comment">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <button type="submit" id="addcom" class="btn btn-primary btn-block">Envoyer</button>
                                    </div>
                                </div>
                            </div>
                        </form>
                        ...
                        <div id="add_comment">
                            ...
                            $request = $db->prepare('SELECT * FROM news_comments WHERE news_url = ? ORDER BY date DESC LIMIT 10');
