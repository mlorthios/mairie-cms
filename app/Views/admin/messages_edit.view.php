                    ...
                    <div class="col-md-8">
                        ...
                        <div class="form-group">
                            <select name="type" class="form-control form-control-lg">
                                ...
                                <option <?php if($f['type'] == 'info') { echo 'selected'; } ?> value="info">Information</option>
                                <option <?php if($f['type'] == 'warning') { echo 'selected'; } ?> value="warning">Avertissement</option>
                                <option <?php if($f['type'] == 'defile') { echo 'selected'; } ?> value="defile">Défilement</option>
                            </select>
                        </div>
                        <div class="form-group">
                            <select name="page" class="form-control form-control-lg">
                                <option selected disabled>Sur quelle page publier le message ?</option>
                                <option <?php if($f['fullpage'] == 1) { echo 'selected'; } ?> value="fullpage">Toutes les pages</option>
                                <option <?php if($f['fullpage'] == 0 && $f['page_id'] == 1) { echo 'selected'; } ?>>Accueil</option>
                                <?php
                                ...
                                while($p = $Pages->fetch()) {
                                    ...
                                    if($f['page_id'] == $p['id'] && $f['fullpage'] == 0) {
