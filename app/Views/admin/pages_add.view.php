				...
				<div class="row">
                    <div class="col-md-10" style="margin-bottom: 15px">
                        <div class="form-group">
                            <input name="title" class="form-control form-control-lg" placeholder="Nom de page" type="text">
                        </div>
                        <div class="form-group">
                            <input name="description" class="form-control form-control-lg" placeholder="Description de page" type="text">
                        </div>
		...
		<script>
            ...
            $('[name="save"]').click(function() {
                ...
                $.ajax({
                    ...
                    url: '/api/admin/pages/add2',
                    type: 'POST',
                    data: { content: content, title: title, parent: parent, ordre: ordre, description: desc },
                    dataType: 'json',
                    success: function(json) {
                        if(json.status == 'success') {
                            $.gritter.add({
                            ...
                            $("[name='save']").prop('disabled', true);
                            $("[name='save']").html('Publication effectué');
                            setTimeout(function() {
