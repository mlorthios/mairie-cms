				...
				<div class="row">
					<div class="col-md-5">
                        <div id="accordion" class="card-accordion">
                            <?= $fpage->ListMenusPages() ?>
                        </div>
                        
                    </div>
                    <div class="col-md-2">
                        <a href="/admin/pages/navigator/add" class="btn btn-primary btn-block">Ajouter un menu de navigation</a>
                        <a href="/admin/pages/add" class="btn btn-primary btn-block">Ajouter une page</a>
                    </div>
				</div>
			</div>
