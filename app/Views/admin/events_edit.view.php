                ...
                <form id="posting" enctype="multipart/form-data"><div class="row">
                    <div class="col-md-10">
                        <div class="form-group">
                            ...
                            <input class="form-control form-control-lg" name="title" value="<?= $f['title']; ?>" placeholder="Titre de l'événement">
                        </div>
                        <div class="form-group">
                            <label>Brève description</label>
                            <input class="form-control form-control-lg" name="description" value="<?= $f['description']; ?>" placeholder="Brève description">
                        </div>
                        <div class="form-group">
                            <label>Date de l'événement</label>
                            <input type="date" class="form-control form-control-lg" value="<?= $f['date_event']; ?>" name="date_event">
                        </div>
                        <textarea id="summernote" name="content"><?= $f['content']; ?></textarea>
                    </div>
                    <div class="col-md-2">
                        <img style="height: auto; width:100%; margin-bottom: 10px" id="blah" src="<?= $f['image']; ?>"/>
