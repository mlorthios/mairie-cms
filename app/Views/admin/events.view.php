		...
		<div id="page-container" class="page-container fade page-sidebar-fixed page-header-fixed">
			...
			<div id="content" class="content">
                <div class="row">
                                ...
                                <div class="table-responsive">
                                    <table class="table table-striped m-b-0">
                                        ...
                                        <tbody>
                                            ...
                                            $Events = $db->query('SELECT * FROM events ORDER BY date DESC');
                                            
                                            while($e = $Events->fetch()) {
                                                echo '<tr id="event'.$e['id'].'">
                                                <td>'.$e['title'].'</td>
                    ...
                    <div class="col-md-2">
                        <a href="/admin/events/add" class="btn btn-primary btn-block">Ajouter un événement</a>
                    </div>
                </div>
			</div>
		...
		<script>
            ...
            function Delete(id) {
                if(confirm('Voulez-vous vraiment supprimer cette événement ?')) {
                    ...
                    $.gritter.add({
                        title: "Notification",
                        text: 'Vous avez annulé la suppression de l\'événement'
                    });
                }
            }
		</script>
