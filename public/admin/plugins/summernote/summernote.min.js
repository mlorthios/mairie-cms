/*! Summernote v0.8.10 | (c) 2013- Alan Hong and other contributors | MIT license */ ! function(t, e) {
    ...
    var e = function() {
        ...
        h = o('<ul class="dropdown-menu" role="list">', function(e, o) {
            var n = t.isArray(o.items) ? o.items.map(function(t) {
                ...
                return '<li role="listitem" aria-label="' + t + '"><a href="#" ' + ('data-value="' + e + '"' + (void 0 !== i ? ' data-option="' + i + '"' : "")) + ">" + n + "</a></li>"
            }).join("") : o.items;
            e.html(n).attr({
                "aria-label": o.title
            })
        ...
        p = o('<ul class="dropdown-menu note-check" role="list">', function(e, o) {
            var n = t.isArray(o.items) ? o.items.map(function(t) {
                var e = "string" == typeof t ? t : t.value || "",
                    n = o.template ? o.template(t) : t;
                return '<li role="listitem" aria-label="' + t + '"><a href="#" data-value="' + e + '">' + b(o.checkClassName) + " " + n + "</a></li>"
            }).join("") : o.items;
            e.html(n).attr({
                "aria-label": o.title
            })
    ...
    t.summernote = t.summernote || {
        ...
        "en-US": {
            font: {
                ...
                size: "Taille d'écriture"
            },
            image: {
                image: "Image",
                insert: "Insérer une image",
                resizeFull: "Redimensionner complètement",
                resizeHalf: "Redimensionner la moitié",
                resizeQuarter: "Redimensionner le quart",
                floatLeft: "Gauche",
                floatRight: "Droite",
                floatNone: "Normal",
                ...
                selectFromFiles: "Sélectionnez parmi les fichiers",
            ...
            help: {
                ...
                redo: "Refait la dernière commande",
                tab: "Tab",
                untab: "Untab",
